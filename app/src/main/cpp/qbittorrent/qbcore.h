...
public:
    ...
    std::string getTorrentListJson();
    std::string getTorrentDetailsJson(const std::string& hash);
    std::string getGlobalStatsJson();
    
    std::string getSettingsJson();
    bool setSettingsJson(const std::string& json);
    
    std::string getPeerListJson(const std::string& hash);
    std::string getTrackerListJson(const std::string& hash);
    std::string getFilesListJson(const std::string& hash);
    bool setFilePriority(const std::string& hash, int index, int priority);
    
    std::string getTransferInfoJson();
    std::string getAllTrackerInfoJson();
